...
static lv_obj_t *btn_demo_3d = NULL;
static lv_obj_t *btn_demo_raytrace = NULL;

static float rt_light_angle = 0.0f;
...
// 3D Voxel Landscape raycaster rendering loop
...
// ============================================================================
// Real-Time Recursive 3D Raytracer
// ============================================================================
...
Vec3 trace_ray(Ray r, int depth) {
